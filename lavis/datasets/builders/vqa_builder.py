...
from lavis.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset, COCOZhVQADataset
...
@registry.register_builder("cocozh_vqa")
class COCOZhVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = COCOZhVQADataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/cocozh/defaults_vqa.yaml",
    }
